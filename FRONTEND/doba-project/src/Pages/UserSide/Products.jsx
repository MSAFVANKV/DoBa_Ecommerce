    ...
    >
      ...
      <div className="w-[100%] h-[200px] sm:h-[70vh] md:flex">
        <div className="lg:w-[50%] w-[100%] h-[100%] bg-slate-200 rounded-e-xl relative flex justify-center items-center">
          <span className="sm:w-[250px] w-[150px]  font-comforter sm:text-[2rem]">
            "Is your day starting with a fresh start? Your day will be
            grateful."
          </span>
          ...
          <div
            className="md:hidden block w-[100px] h-[100px] sm:w-[150px] sm:h-[150px] gap-4 bg- bg-contain rounded-full"
        ...
        <div className="lg:w-[50%] w-[100%] hidden md:flex justify-center items-center bg-cover bg-center bg-no-repeat">
          {/* rounded image start */}
          <div
            className="lg:w-[350px] md:w-[270px] md:flex justify-center items-center lg:h-[350px] md:h-[270px]  bg- bg-contain rounded-full"
            style={{ backgroundImage: `url(${texture_2})` }}
          >
            <div
              className="lg:w-[350px] md:w-[250px] lg:h-[350px] md:h-[250px] bg-cover rounded-full shadow-2xl"
              style={{ backgroundImage: `url(${idly1})` }}
            ></div>
          </div>
